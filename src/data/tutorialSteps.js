...
export const TUTORIAL_STEPS = [
  {
    ...
    title: "환영합니다!",
    description:
      "**게스트**로 바로 이용하거나, **깨사모 로그인** 후 문의(쪽지) 기능을 쓸 수 있습니다.\n프로그램 사용법을 안내합니다.\n화면 아무 곳이나 클릭하면 다음으로 넘어갑니다.",
  },
  {
    id: "course-day",
    target: "course-day",
  ...
  },
  {
    ...
    title: "계정",
    description:
      "**계정**에서 **깨사모 로그인** 또는 **게스트** 이용을 선택할 수 있습니다.\n**게스트**: 암송 진행·설정은 이 기기·브라우저에만 저장됩니다.\n**로그인**: 이름·교회 등 프로필 확인, **정보 → 문의하기**로 깨사모 쪽지 발송이 가능합니다.\n로그인 상태는 약 2주간 유지되며, **로그아웃**으로 세션을 해제할 수 있습니다.",
    placement: "bottom",
  },
  {
    id: "info",
